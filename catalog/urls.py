...
from catalog.views import SearchView, SearchResultsView, AlbumView, ArtistView, TrackCreateView, AlbumCreateView, \
    ArtistCreateView, GenreCreateView, TrackUpdateView, AlbumUpdateView, ArtistUpdateView, GenreUpdateView, \
    TrackDeleteView, AlbumDeleteView, ArtistDeleteView, GenreDeleteView
...
urlpatterns = [
    ...
    path('genres/<int:genre_id>/edit/', GenreUpdateView.as_view(), name='genre_edit'),
